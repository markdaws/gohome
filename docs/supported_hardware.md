Here is a list of the hardware goHOME currently supports. If you want more added, file an issue, maybe update the goHOME code or donate some hardware :) so we can add it.
